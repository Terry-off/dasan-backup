...
var SITE_SECTION_YOUTUBE = function(){
	...
	var tv;
	var vid;
	var playerDefaults = {'autoplay': 1, 'mute': 1, 'playsinline': 1, 'autohide': 1, 'modestbranding': 0, 'rel': 0, 'showinfo': 0, 'controls': 0, 'disablekb': 1, 'enablejsapi': 1, 'iv_load_policy': 3};
	var screen_code;
	var slide_code;
	var id;
	var $screen;
	...
	var onPlayerReady = function(){
		...
		tv.mute();
		/* BACKUP_FORCE_PLAY */ (function(){var n=0,t=setInterval(function(){n++;try{tv.mute();tv.playVideo();}catch(e){}if(n>12||(tv.getPlayerState&&tv.getPlayerState()===1))clearInterval(t);},600);})();
...
var SECTION_PARTICLE_ANIMATION = function(){
	...
	particleImage.src = 'assets/dasanbaruntong.imweb.me/common/img/ParticleSmoke.png';
